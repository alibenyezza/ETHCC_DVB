  ...
  return (
    <div className="p-6 bg-black/40 backdrop-blur-md rounded-xl border border-gray-800/60 w-full flex flex-col h-full">
      ...
      <div className="flex justify-between text-sm text-white/50 mb-auto px-1 pb-6">
        ...
        <span className="text-white/80 font-medium">85,000.00 USDC</span>
      </div>
      
      <button className="w-full py-4 bg-transparent border border-white/40 text-white font-bold uppercase tracking-wider rounded-lg hover:bg-white/10 transition-all hover:scale-[1.02]">
        Withdraw Capital
      </button>
    </div>
  );

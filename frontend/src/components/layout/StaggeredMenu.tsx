    ...
    >
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <button
          ...
          type="button"
        >
          <div className="sm-logo-text" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <svg width="24" height="24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20 20 L80 20 L40 80 L80 80" stroke="white" strokeWidth="12" strokeLinecap="square" strokeLinejoin="miter" />
              <path d="M20 80 L60 20" stroke="white" strokeWidth="12" strokeLinecap="square" strokeLinejoin="miter" />
            </svg>
            <span className="sm-logo-label" style={{ fontFamily: 'var(--font-serif)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>{logoText}</span>
          </div>
        </button>
